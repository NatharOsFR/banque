...
public class PersonneMorale extends Personne {
    ...
    public TypePersonneMorale getTypePersonneMorale() { return typePersonneMorale; }
    public void setTypePersonneMorale(TypePersonneMorale typePersonneMorale) { this.typePersonneMorale = typePersonneMorale; }
    ...
    public String toString() {
        return "\nPersonneMorale{" +
                ...
                ", \nadresse='" + adresse + '\'' +
                ", typePersonneMorale=" + (typePersonneMorale != null ? typePersonneMorale.getIntitule() : "null") +
                "}\n";
    }

    public String nomComplet() { return raisonSociale; }
